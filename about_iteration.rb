...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    #
    # It gets a default value and then in each iteration it updates the default/starting value with current item
    # based on operation we defined in the block.
  end
  ...
  #
  # Because this way file is closed at the end and it's not "permanently" stored in the memory?
