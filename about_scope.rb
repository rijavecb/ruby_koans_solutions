...
class AboutScope < Neo::Koan
  ...
  def test_nested_string_is_not_the_same_as_the_system_string
    assert_equal false, String == "HI".class # Not sure why? irb says "HI".class is String
  end

  def test_use_the_prefix_scope_operator_to_force_the_global_scope
    assert_equal true, ::String == "HI".class # Same about this... I got ::String.class to be Class
  end
